...
const Reports = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Cabeçalho */}
      <div className="bg-primary text-primary-foreground px-6 py-8 shadow-lg">
        <div className="container mx-auto">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Brain className="h-8 w-8" />
              <h1 className="text-2xl font-bold">Relatórios Inteligentes - Decisões Baseadas em Dados</h1>
            </div>
      ...
      <div className="bg-gradient-to-b from-muted/50 to-muted py-12 mt-12">
